  ...
  <div class="container-fluid">
    ...
    <div class="col-lg-4 col-md-6"> <!-- Adjust column size for responsiveness -->
      <div class="small-box bg-primary">
        ...
        <div class="icon">
          <i class="fas fa-calendar-check"></i> <!-- Icon for Appointment List -->
        </div>
        <a href="appointment_list.php" class="small-box-footer">View Appointments <i class="fas fa-arrow-circle-right"></i></a>
      </div>
    </div>
              ...
              <tbody>
                  ...
                  if (mysqli_num_rows($result) > 0) {
                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        // Get the timestamp of the schedule date
                        $scheduleTimestamp = strtotime($row['date']);
                        
                        // Check if the schedule date is overdue
                        $isOverdue = $currentTimestamp > $scheduleTimestamp;
                        
                        // Determine the button class based on whether the date is overdue
                        $buttonClass = $isOverdue ? 'btn-danger' : 'btn-success';
                          echo "<tr>";
                          echo "<td>" . $row['patient_id'] . "</td>";
                          echo "<td>" . $row['firstname'] . " " . $row['middlename'] . " " . $row['lastname'] . "</td>";
                          echo "<td>" . $row['age'] . "</td>";
                          echo "<td><button class='timeBtn btn-sm $buttonClass'>" . $row['date'] . "</button></td>";

    ...
    <div class="wrapper">
                                ...
                                <div class="card-body">
                                    <table id="scheduleTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            // Fetch data from the schedule table for patients with bill_generate value either 'done' or 'Payment Done'
        ...
        WHERE schedule.bill_generate = 'prescription unchecked'";
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                ...
                                                echo "<tr><td colspan='7'>No schedule entries found for patients with bill generate value 'done' or 'Payment Done'</td></tr>";
                                            }
                                            ?>

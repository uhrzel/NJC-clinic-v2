                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="editPatientForm">
                            ...
                            <div class="form-group">
                                <label for="editPatientPayment">Payment:</label>
                                <input type="text" class="form-control" id="editPatientPayment" name="editPatientPayment" readonly>
                            </div>
            ...
            function setPayment() {
                ...
                switch (problem) {
                    case "Teeth Cleaning":
                        ...
                        break;
                    case "Whitening":
                        paymentInput.value = "5000";
                        break;
                    case "Extractions":
                        paymentInput.value = "1000";
                        break;
                    case "Veneers":
                        paymentInput.value = "10000";
                        break;
                    case "Filling":
                        paymentInput.value = "1000";
                        break;
                    case "Crowns":
                        ...
                        break;
                    case "Root Canal":
                        paymentInput.value = "15000";
                        break;
                    case "Brace/Invisalign":
                        paymentInput.value = "60000";
                        break;
                    default:
